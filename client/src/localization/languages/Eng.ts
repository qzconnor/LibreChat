...
export default {
  ...
  com_ui_custom_settings: 'Save Chat to AMS',
  com_ui_send_feedback_to_support: 'Send Feedback to Support',
  com_ui_send_mail_to_ams: 'Send Mail to AMS',
  ...
  com_ui_salesperson: 'Salesperson',
